// Finals.ArrayFunc.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//

#include <iostream>

void fillArray(int, int*);
void arrayRoutine(int, int*);
...
void arrayRoutine(int n, int* array)
{
    int s = 0;
    int sMinus = 0;
    int sPlus = 0;
